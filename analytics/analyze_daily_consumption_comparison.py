...
def analyze_daily_consumption(df, resolution_name):
    ...
    print(f"Average daily consumption: {daily_consumption.mean():.2f} Wh ({daily_consumption.mean()/1000:.2f} kWh)")
    print(f"Median daily consumption: {daily_consumption.median():.2f} Wh ({daily_consumption.median()/1000:.2f} kWh)")
    print(f"Standard deviation: {daily_consumption.std():.2f} Wh ({daily_consumption.std()/1000:.2f} kWh)")
    print(f"Min daily consumption: {daily_consumption.min():.2f} Wh ({daily_consumption.min()/1000:.2f} kWh)")
    print(f"Max daily consumption: {daily_consumption.max():.2f} Wh ({daily_consumption.max()/1000:.2f} kWh)")
...
def main():
    ...
    print(f"Difference: {abs(daily_1min.mean() - daily_5min.mean()):.2f} Wh ({abs(daily_1min.mean() - daily_5min.mean())/daily_1min.mean()*100:.1f}%)")
    
    print(f"\n1-minute std: {daily_1min.std():.2f} Wh")
    print(f"5-minute std: {daily_5min.std():.2f} Wh")
    print(f"Difference: {abs(daily_1min.std() - daily_5min.std()):.2f} Wh ({abs(daily_1min.std() - daily_5min.std())/daily_1min.std()*100:.1f}%)")
